...
export const HeroContent = () => {
  ...
  return (
    <>
      <div
        id="row1"
        className="flex justify-between mb-[26px] md:mb-[62px] xl:mb-[232px]"
      >
      ...
      <div className="flex justify-between xl:justify-end items-end">
        ...
        <div
          id="bottom-right"
          className="flex flex-col items-end text-[8px] md:text-base md:leading-[16px] xl:leading-[24px] -tracking-[0.01em] text-right "
        >
      ...
      <div
        id="face-wrapper"
        className="h-auto md:h-[403px] xl:h-[659px] max-md:w-[62%] md:w-[381px] xl:w-[625px] absolute bottom-[-7px] md:bottom-[-12px] xl:bottom-[-17px] left-1/2 md:left-[43%] xl:left-[52%] transform translate-x-[-50%] z-10 object-cover "
      >
        <Image
          src={HeroImg}
          alt={`${name} ${surname}`}
